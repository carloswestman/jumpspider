            ...
            it('it retrieves the first job\'s parsed table', function(done) {
                chai.request(url)
                    ...
                    .end(function(err, res) {
                        ...
                        res.body[0].C3_W.should.equal('49');
                        res.body[0].C4_L.should.equal('33');
                        res.body[0].C5_PCT.should.equal('0.598');
                        res.body[0].C12_STREAK.should.equal('W 1');
                        done();
                    });
            });
                ...
                it('it retrieves the second job\'s parsed table', function(done) {
                    chai.request(url)
                        ...
                        .end(function(err, res) {
                            ...
                            res.body.should.be.a('array');
                            res.body[0].C0_NAME.should.equal('Toronto');
                            res.body[0].C3_W.should.equal('48');
                            res.body[0].C4_L.should.equal('34');
                            res.body[0].C5_PCT.should.equal('0.585');
                            res.body[0].C12_STREAK.should.equal('L 1');
                            done();
                        });
                });
                    ...
                    it('it retrieves the third job\'s parsed table', function(done) {
                        chai.request(url)
                            ...
                            .end(function(err, res) {
                                ...
                                res.body[0].C3_W.should.equal('54');
                                res.body[0].C4_L.should.equal('28');
                                res.body[0].C5_PCT.should.equal('0.659');
                                res.body[0].C12_STREAK.should.equal('W 1');
                                done();
                            });
                    });
